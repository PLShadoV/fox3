...
export default function RootLayout({ children }: { children: ReactNode }) {
  return (
    <html lang="pl" suppressHydrationWarning>
      <head>
        {/* Domyślnie DARK + respektowanie zapisanej preferencji */}
        <script
        ...
        <style>{`
          ...
          * { box-sizing: border-box; }
          body {
            margin: 0;
            background:
              radial-gradient(1200px 800px at 80% -10%, rgba(106,169,255,0.12), transparent),
              var(--bg);
            color: var(--text);
          ...
          .chip.active {
            background: linear-gradient(180deg, rgba(106,169,255,0.22), rgba(61,106,255,0.18));
            border-color: rgba(106,169,255,0.4);
          }
          .chip.link:hover { filter: brightness(1.12); }
